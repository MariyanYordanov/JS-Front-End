...
function toggle() {
    ...
    const contentBtn = document.getElementsByClassName("button")[0];

    const displayHiddenDiv = document.getElementById("extra");

    if (contentBtn.textContent === "More") {
        displayHiddenDiv.style.display = "block";
        contentBtn.textContent = "Less";
    } else {
        displayHiddenDiv.style.display = "none";
        contentBtn.textContent = "More";
    }
}